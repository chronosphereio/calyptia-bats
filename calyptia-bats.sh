...
export BATS_HELPERS_ROOT=${BATS_HELPERS_ROOT:$SCRIPT_DIR}
export BATS_CUSTOM_HELPERS_ROOT=${BATS_CUSTOM_HELPERS_ROOT:$TEST_ROOT/helpers/}
...
# Now source any additional `-helpers.bash` files we fine in BATS_CUSTOM_HELPERS_ROOT
for CUSTOM_HELPER_FILE in "$BATS_CUSTOM_HELPERS_ROOT"/*-helpers.bash
do
